...
<% request.setAttribute("pageTitle", "新增保養排程"); %>
...
<body>
    ...
    <div class="form-container">
        <h2><i class="fas fa-calendar-plus"></i> 新增保養排程</h2>
        <p style="text-align: center; color: #555; margin-top: -1rem; margin-bottom: 2rem;">請填寫以下資訊以建立新的保養排程。</p>
        ...
        <form action="${pageContext.request.contextPath}/InsertMaintenance" method="post" id="insertMaintenanceForm">
            <div class="form-group">
                <label for="machineId"><i class="fas fa-microchip"></i> 機台編號：</label>
                <input type="number" id="machineId" name="machineId" required min="1" placeholder="請輸入機台的唯一編號，例如：101">
                <div id="machineIdError" class="error-text"></div>
                <small style="color: #666; display: block; margin-top: 5px;">請確認輸入的機台編號為一個存在的正整數。</small>
            </div>

            <div class="form-group">
                <label for="maintenanceDescription"><i class="fas fa-align-left"></i> 保養描述：</label>
                <textarea id="maintenanceDescription" name="maintenanceDescription" required placeholder="請簡要描述此次保養的內容或目的，例如：每月例行檢查及潤滑。"></textarea>
                <div id="maintenanceDescriptionError" class="error-text"></div>
                <small style="color: #666; display: block; margin-top: 5px;">建議清楚說明保養範圍和細節。</small>
            </div>

            <div class="form-group">
                <label for="employeeId"><i class="fas fa-user-tie"></i> 員工編號：</label>
                <input type="number" id="employeeId" name="employeeId" required min="1" placeholder="請輸入負責保養的員工編號，例如：2001">
                <div id="employeeIdError" class="error-text"></div>
                <small style="color: #666; display: block; margin-top: 5px;">請確認輸入的員工編號為一個存在的正整數。</small>
            </div>

            <div class="form-actions">
                <button type="submit">
                    <i class="fas fa-check-circle"></i> 送出排程
                </button>
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('insertMaintenanceForm');
