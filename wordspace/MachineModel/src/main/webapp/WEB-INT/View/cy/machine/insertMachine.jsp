...
<% request.setAttribute("pageTitle", "新增機台資料"); %>
...
<body>
    ...
    <div class="form-container">
        ...
        <form id="machineForm" action="${pageContext.request.contextPath}/InsertMachineServlet" method="post">
            <div>
                <label for="machineName">機台名稱：</label>
                <input type="text" id="machineName" name="machineName" value="${param.machineName}" required>
                <div id="machineNameError" class="error-text"></div>
            </div>

            <div>
                <label for="serialNumber">出廠編號：</label>
                <input type="text" id="serialNumber" name="serialNumber" value="${param.serialNumber}" required>
                <div id="serialNumberError" class="error-text"></div>
            </div>

            <div>
                <label for="mstatus">機台狀況：</label>
                <select id="mstatus" name="mstatus" required>
                    <option value="">請選擇機台狀況</option>
                    <option value="停機" <c:if test="${param.mstatus == '停機'}">selected</c:if>>停機</option>
                    <option value="運行中" <c:if test="${param.mstatus == '運行中'}">selected</c:if>>運行中</option>
                    <option value="維護中" <c:if test="${param.mstatus == '維護中'}">selected</c:if>>維護中</option>
                    <%-- 你可以根據需求增加更多狀態選項 --%>
                </select>
            ...
            <div>
                ...
                <input type="text" id="machineLocation" name="machineLocation" value="${param.machineLocation}">
                <div id="machineLocationError" class="error-text"></div>
            </div>

            <div class="button-group">
                <button type="submit">
                    <i class="fas fa-plus-circle"></i> 新增機台
                </button>
