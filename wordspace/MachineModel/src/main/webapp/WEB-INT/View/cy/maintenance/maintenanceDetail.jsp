    ...
    <div class="detail-container">
        ...
        <ul class="detail-list">
            ...
            <li>
                ...
                <span class="value">
                    <c:choose><c:when test="${not empty maintenance.scheduleDate}">
                            <fmt:parseDate value="${maintenance.scheduleDate}" pattern="yyyy-MM-dd'T'HH:mm:ss.SSS" var="parsedScheduleDate" />
                            <fmt:formatDate value="${parsedScheduleDate}" pattern="yyyy 年 MM 月 dd 日 HH:mm" />
                        </c:when><c:otherwise>
                            N/A
            ...
            <li>
                ...
                <span class="value">
                    <c:choose><c:when test="${not empty maintenance.createTime}">
                            <fmt:parseDate value="${maintenance.createTime}" pattern="yyyy-MM-dd'T'HH:mm:ss.SSS" var="parsedCreateTime" />
                            <fmt:formatDate value="${parsedCreateTime}" pattern="yyyy 年 MM 月 dd 日 HH:mm" />
                        </c:when><c:otherwise>
                            N/A
                        </c:otherwise></c:choose>
                </span>
            ...
            <li>
                ...
                <span class="value">
                    <c:choose><c:when test="${not empty maintenance.updateTime}">
                            <fmt:parseDate value="${maintenance.updateTime}" pattern="yyyy-MM-dd'T'HH:mm:ss.SSS" var="parsedUpdateTime" />
                            <fmt:formatDate value="${parsedUpdateTime}" pattern="yyyy 年 MM 月 dd 日 HH:mm" />
                        </c:when><c:otherwise>
                            N/A
                        </c:otherwise></c:choose>
                </span>
